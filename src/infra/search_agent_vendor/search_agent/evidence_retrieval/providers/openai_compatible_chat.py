...
class OpenAICompatibleChatClient:
    ...
    closed JSON for concurrent HTTP/2 streams.  Two pooled HTTP/1.1
    connections retain keep-alive/concurrency without that transport issue.
    """
    ...
    @classmethod
    def from_env(cls, *, model: str | None, timeout_seconds: float = 35.0):
