...
| T-05 | 翻译层 + trace_events | done | T-04 | 0023 | §6.4, §10.2, §4.2.2 |
| T-06 | WS sender（只读尾随） | done | T-05 | 0023 | §6.1–6.5, §1.3 |
| T-07 | React 工作台 | done | T-06, T-04, T-02 | — | §7, §6.5 |
| T-08 | 运维加固 | done | T-04, T-05 | — | §9, §11, §3.3 |
