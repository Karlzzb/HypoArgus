...
| T-02 | MANIFEST 展示元数据 + 可见性 | todo | — | — | §10.1, §5.4, §7.3 |
| T-03 | 持久化异步 HITL（spine） | todo | T-01 | 0022 | §1.4, §4.1–4.2.1–2, §10.2–10.4 |
| T-04 | HTTP 控制面 | todo | T-03, T-02 | 0022 | §5, §3.2, §4.2.4–5, §8 |
